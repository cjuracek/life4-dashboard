...
pearl_1 = Life4Rank(
    ...
    requirements=[
        ...
        PFCRequirement(level=15, num=15),
        ...
        ClearRequirement(  # Not exactly the same, but close enough
            level=17, num=56, num_exceptions=12, exception_floor=810_000
        ),
...
pearl_2 = Life4Rank(
    ...
    requirements=[
        ...
        # 17s
        FloorRequirement(  # Not exactly the same, but close enough
            level=17, floor=870_000, num_exceptions=14, exception_floor=820_000
        ),
